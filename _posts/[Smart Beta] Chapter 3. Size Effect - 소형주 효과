...
```python
df = pd.read_excel('/Users/taehyeon/pythonfiles/data/smb_cumreturn_data.xlsx', index_col = 0)
...
```python
df_glo = pd.read_excel('/Users/taehyeon/pythonfiles/data/시가총액가중 기준 소형 RMW- 대형 RMW.xlsx',sheet_name=0, index_col=0)
df_exus = pd.read_excel('/Users/taehyeon/pythonfiles/data/시가총액가중 기준 소형 RMW- 대형 RMW.xlsx',sheet_name=1, index_col=0)
df_eu = pd.read_excel('/Users/taehyeon/pythonfiles/data/시가총액가중 기준 소형 RMW- 대형 RMW.xlsx',sheet_name=2, index_col=0)
df_jpn = pd.read_excel('/Users/taehyeon/pythonfiles/data/시가총액가중 기준 소형 RMW- 대형 RMW.xlsx',sheet_name=3, index_col=0)
df_exjpn = pd.read_excel('/Users/taehyeon/pythonfiles/data/시가총액가중 기준 소형 RMW- 대형 RMW.xlsx',sheet_name=4, index_col=0)
